...
- Prefer deactivation or draft status instead of deleting data. Deactivated providers keep their public URLs with prominent stopped-operating notices (HTTP 200, indexable, sitemap priority 0.3); deactivated card BINs show notices too but stay noindex.
